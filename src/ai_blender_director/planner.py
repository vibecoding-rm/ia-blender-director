    ...
    "shots": [
        {
            ...
            "character_asset": "cotorra_v1 (presentadora), comandante_cerdo_v1 (vocero), humbrete_v1 (fiscal sabueso), ciberclarias_v1 (troll/enjambre), protagonista_v2 (humano genérico), or null",
